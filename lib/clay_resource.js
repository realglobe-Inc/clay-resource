...
const { cloneMix, processMix, refMix, annotateMix, subMix } = require('./mixins')
...
class ClayResource extends ClayResourceBase {
  ...
  list (condition = {}) {
    ...
    return co(function * () {
      ...
      return s.processCollection(collection)
    })
  }
  ...
  create (attributes = {}) {
    ...
    return co(function * () {
      ...
      return s.processEntity(created)
    })
  }
  ...
  update (id, attributes = {}) {
    ...
    return co(function * () {
      ...
      return s.processEntity(updated)
    })
  }
  ...
  oneBulk (ids) {
    ...
    return co(function * () {
      ...
      return s.processEntityHash(oneHash)
    })
  }
  ...
  listBulk (conditionArray = []) {
    ...
    return co(function * () {
      ...
      return s.processCollectionArray(collectionAlly)
    })
  }
  ...
  createBulk (attributesArray = []) {
    ...
    return co(function * () {
      ...
      return s.processEntityArray(createdArray)
    })
  }
  ...
  updateBulk (attributesHash = {}) {
    ...
    return co(function * () {
      ...
      return s.processEntityHash(updatedHash)
    })
  }
  ...
  first (filter) {
    ...
    return co(function * () {
      ...
      return s.processEntity(entities[ 0 ])
    })
  }
