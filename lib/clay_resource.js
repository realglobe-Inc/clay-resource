...
class ClayResource extends ClayResourceBase {
  ...
  async create (attributes = {}, options = {}) {
    ...
    this.emit(ENTITY_CREATE, {created})
    await tick()
    return created
  }
  ...
  async update (id, attributes = {}, options = {}) {
    ...
    this.emit(ENTITY_UPDATE, {id, old, updated})
  ...
  async destroy (id) {
    ...
    this.emit(ENTITY_DESTROY, {id, gone, destroyed})
    this.emit(INVALIDATE, {id})
    await tick()
    return destroyed
  }
  ...
  async createBulk (attributesArray = [], options = {}) {
    ...
    this.emit(ENTITY_CREATE_BULK, {created})
    await tick()
    return created
  }
  ...
  async updateBulk (attributesHash = {}, options = {}) {
    ...
    this.emit(ENTITY_UPDATE_BULK, {ids, updated, old})
    this.emit(INVALIDATE_BULK, {ids})
    await tick()
    return updated
  }
  ...
  async destroyBulk (ids = []) {
    ...
    this.emit(ENTITY_DESTROY_BULK, {ids, destroyed, gone})
    this.emit(INVALIDATE_BULK, {ids})
    await tick()
    return destroyed
  }
