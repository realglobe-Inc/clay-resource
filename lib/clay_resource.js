...
class ClayResource extends ClayResourceBase {
  ...
  async update (id, attributes = {}, options = {}) {
    ...
    const values = asEntity().set(attributes).as(s._resourceNameString).toValues()
  ...
  async createBulk (attributesArray = [], options = {}) {
    ...
    await s.prepareIfNeeded()
    let actionContext = actionContextFor('createBulk', {allowReserved, errorNamespace})
