...
class ClayResource extends ClayResourceBase {
  ...
  create (attributes = {}) {
    ...
    return co(function * () {
      ...
      let created = yield s.outboundEntity(raw)
  ...
  update (id, attributes = {}) {
    ...
    return co(function * () {
      ...
      let updated = yield s.outboundEntity(raw)
  ...
  createBulk (attributesArray = []) {
    ...
    return co(function * () {
      ...
      let created = yield s.outboundEntityArray(raw)
  ...
  updateBulk (attributesHash = {}) {
    ...
    return co(function * () {
      ...
      let updated = yield s.outboundEntityHash(raw)
  ...
  first (filter, options = {}) {
    ...
    return co(function * () {
      ...
      return yield s.outboundEntity(entities[ 0 ])
    })
  }
